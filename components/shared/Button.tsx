...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    secondary: 'bg-secondary hover:bg-pink-600 text-white focus:ring-secondary',
  ...
  return (
    <button
      className={`${baseStyles} ${sizeStyles[size]} ${variantStyles[variant]} ${props.disabled || isLoading ? disabledStyles : ''} ${className}`}
